...
onWindowResize() {
    ...
    init() {
      ...
      this.camera = new THREE.PerspectiveCamera(750,window.innerWidth / window.innerHeight,1,1000);
      ...
      let contorl = new THREE.OrbitControls(this.camera, this.renderer.domElement);
      console.log(contorl)
      this.onWindowResize()
